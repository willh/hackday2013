...
class SampleData
    ...
    def self.load
        ...
        sampledata << Feedback.create(
            :location => "Ward 64", 
            :date => "2013-05-18 08:30:40", 
            :time_of_day => "Morning", 
            :type => "miscommunication", 
            :incident_points => ["no_reason_procedures"], 
            :incident_comments => "Nobody gave us information on why so many blood tests are being done.", 
            :good_points => ["helpful", "friendly"], 
            :bad_points => [], 
            :general_comments => "Nurses were nice but didn't tell us what tests they were doing.", 
            :severity => "amber", 
            :safety => "amber", 
            :happened_before => "no",
            :told_us => "yes",
        ...
        sampledata << Feedback.create(
            :location => "Ward 64", 
            :date => "2013-05-25 09:30:40", 
            :time_of_day => "Morning", 
            :type => "miscommunication", 
            :incident_points => ["no_follow_up"], 
            :incident_comments => "My son was discharged with no follow up or discharge letter", 
            :good_points => ["helpful", "friendly"], 
            :bad_points => [], 
            :general_comments => "", 
            :severity => "red", 
